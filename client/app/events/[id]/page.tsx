    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl border border-gray-200 bg-white shadow-lg overflow-hidden">
          {/* Event Image */}
          <div className="relative h-64 w-full bg-gray-100 sm:h-96">
            {event.event_image ? (
              <Image
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mb-6">
              <div className="flex items-start justify-between gap-4 mb-4">
                ...
                <span className="inline-flex items-center rounded-full bg-red-100 px-4 py-2 text-sm font-semibold uppercase tracking-wide text-red-700">
                  {event.food_type}
                </span>
              </div>
            ...
            {event.event_description && (
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed whitespace-pre-line">{event.event_description}</p>
              </div>
            )}
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center rounded-full bg-red-50 px-4 py-2 text-sm font-semibold text-red-700"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="mb-6 rounded-2xl border border-gray-200 bg-gray-50 p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Servings Available</p>
